...
export function MobileHero() {
  return (
    ...
    >
      ...
      <h1
        data-mobile-reveal="hero-headline"
        className="mt-4 font-display text-5xl leading-[1.04] tracking-tight text-matcha-950"
      >
      ...
      <p
        data-mobile-reveal="hero-tagline"
      ...
      <div
        data-mobile-reveal="hero-pack"
        className="relative mt-12 aspect-[4/5] w-full overflow-hidden rounded-3xl bg-cream-100"
      >
        <Image
